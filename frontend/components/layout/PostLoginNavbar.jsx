...
const dropdownItems = [
  ...
  { type: 'link', name: 'Subscription', href: '/subscription', icon: 'M12 1v22M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6' },
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-40 flex h-[63px] items-center justify-between border-b border-[#FF5500]/20 bg-[#0A0A0A] px-4 shadow-[0_0_20px_rgba(255,85,0,0.08)] md:px-8">
      ...
      <div className="flex items-center space-x-3">
        <Link href="/notifications" className="relative rounded-lg p-2 text-white/50 transition-colors hover:bg-white/5 hover:text-[#FF5500]">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          >
            <div className="flex h-7 w-7 items-center justify-center overflow-hidden rounded-full bg-[#FF5500]/20 text-xs font-semibold text-[#FF5500]">
              {userProfileImage ? (
            ...
            {isPro && (
              <span className="flex items-center gap-0.5 rounded bg-[#FF6B00] px-1.5 py-0.5 text-[10px] font-bold leading-none text-black">
                PRO
